...
/** 1. Object 对象  本章介绍该对象原生的各种方法 */

/*
    Object 对象的原生方法 分两类：1） Object本身的方法；  2）Object的实例方法

    1） Object本身的方法；
        直接定义在Object对象的方法： Object.print = function(o){ console.log(o)};
    
    2）Object的实例方法：
        定义在Object原型对象Object.prototype上的方法，它可以被Object实例直接使用
...
2. Object()：本身是一个函数，可以当作工具方法使用，将任意值转为对象。这个方法常用于保证某个值一定是对象。
            - 如果参数为空（或者为undefined和null），Object()返回一个空对象。
                ...
                上述代码表： 将undefined和null转为对象，结果得到了一个空对象obj。
            ...
            利用这一点，可以写一个判断变量是否为对象的函数
                ...
                console.log(isObject(234));

3. Object 构造函数：
    Object不仅可以当作工具函数使用，还可以当作构造函数使用，即前面可以使用new命令。
    Object构造函数的首要用途，是直接通过它来生成新对象。
        var obj = new Object(); //简便写法: var obj = {};
    ...
    注意：虽然用法相似，但是Object(value)与new Object(value)两者的语义是不同的，
        Object(value)表示将value转成一个对象，new Object(value)则表示新生成一个对象，它的值是value。

    
4. Object的静态方法： 是指部署在Object对象自身的方法。
    4.1：Object.keys() 方法和 Object.getOwnPropertyNames() 方法都用来 遍历对象的属性。            
        Object.keys方法的参数是一个对象，返回一个数组。该数组的成员都是该对象自身的（而不是继承的）所有属性名。
        
        对于一般的对象来说，Object.keys()和Object.getOwnPropertyNames()返回的结果是一样的。

        只有涉及不可枚举属性时，才会有不一样的结果。Object.keys方法只返回可枚举的属性（详见《对象属性的描述对象》一章），
        ...
        一般情况下，几乎总是使用Objectk.keys方法，遍历数组的属性
    ...
    5. Object 的实例方法：
        ...
        5.1  Object.prototype.valueOf() : 返回一个对象的“值”，默认情况下返回对象本身、
        
        5.2  Object.prototype.toString(): 返回一个对象的字符串，默认情况下返回类型字符串、
                var o1 = new Object();
            ...
            - 字符串[object Object]本身没有太大的用处，但是通过自定义toString方法，可以让对象在自动类型转换时，得到想要的字符串形式。
                var obj = new Object();
                obj.toString = function(){ return 'world'; };
                console.log('hello ' + obj.toString()); // hello world      当对象用于字符串加法时，会自动调用toString方法
        ...
        5.3 toString() 的应用：判断数据类型
            ...
            - 所以为了得到类型字符串，最好直接使用Object.prototype.toString方法。
                ...
                利用这个特性，可以写出一个比typeof运算符更准确的类型判断函数。（具体略）
                在上面这个type函数的基础上，还可以加上专门判断某种类型数据的方法。（具体略）
        
        5.4  Object.prototype.toLocaleString(): Object.prototype.toLocaleString方法与toString的返回结果相同，也是返回一个值的字符串形式。
        ...
        5.5 Object.prototype.hasOwnProperty(): 接受一个字符串作为参数，返回一个布尔值，表示该实例对象自身是否具有该属性。
                var obj = {
                    p: 123
                };
